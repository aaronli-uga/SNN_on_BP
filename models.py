'''
Author: Qi7
Date: 2022-08-16 16:40:59
LastEditors: aaronli-uga ql61608@uga.edu
LastEditTime: 2022-08-16 17:12:40
Description: 
'''
import torch
...
class STCN(nn.Module):
    ...
    def __init__(self, num_inputs, num_channels, kernel_size=2, dropout=0.2):
        ...
        self.relu = nn.ReLU()
        self.covnet = nn.Conv1d(in_channels=num_channels[-1], out_channels=1, kernel_size=1)
